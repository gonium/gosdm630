...
// Scheduler interface that each scheduler must implement.
type Scheduler interface {
	Produce(devid uint8) []QuerySnip
	GetProbeSnip(devid uint8) QuerySnip
}

// SDMRoundRobinScheduler is a round-robin scheduler for the Eastron SDM Devices
...
// JanitzaRoundRobinScheduler is a round-robin scheduler for the Janitza B23 DIN-Rail meters
...
// DZGRoundRobinScheduler is a round-robin scheduler for the DGZ meters
