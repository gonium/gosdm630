...
const (
	...
	// OpCodeSDML1ApparentPower = 0x0012
	// OpCodeSDML2ApparentPower = 0x0014
	// OpCodeSDML3ApparentPower = 0x0016
	// OpCodeSDML1ReactivePower = 0x0018
	// OpCodeSDML2ReactivePower = 0x001A
	// OpCodeSDML3ReactivePower = 0x001C
	OpCodeSDML1Cosphi = 0x001e
	OpCodeSDML2Cosphi = 0x0020
	OpCodeSDML3Cosphi = 0x0022
	// OpCodeSDML1PhaseAngle    = 0x0024
	// OpCodeSDML2PhaseAngle    = 0x0026
	// OpCodeSDML3PhaseAngle    = 0x0028
	// OpCodeSDMAvgLineVoltageNeutral    = 0x002a
	// OpCodeSDMAvgLineCurrent    = 0x002e
	OpCodeSDMTotalLineCurrent = 0x0030
	OpCodeSDMTotalPower       = 0x0034
	// OpCodeSDMTotalApparentPower = 0x0038
	// OpCodeSDMTotalReactivePower = 0x003C
	OpCodeSDMTotalCosphi = 0x003E
	// OpCodeSDMTotalPhaseAngle = 0x0042
	OpCodeSDMFrequency   = 0x0046
	OpCodeSDMTotalImport = 0x0048
	OpCodeSDMTotalExport = 0x004a
	// OpCodeSDMTotalImportReactive = 0x004C
	// OpCodeSDMTotalExportReactive = 0x004E
	// OpCodeSDMTotalApparent       = 0x0050
	...
	// OpCodeSDML1Total     = 0x0166
	// OpCodeSDML2Total     = 0x0168
	// OpCodeSDML3Total     = 0x016A
